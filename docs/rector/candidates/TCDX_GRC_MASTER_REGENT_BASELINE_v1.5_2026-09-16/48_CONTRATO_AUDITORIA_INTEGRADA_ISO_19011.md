...
| Campo | Valor |
|---|---|
| Candidate | `TCDX_GRC_MASTER_REGENT_BASELINE_v1.5_2026-09-16` |
...
No autoriza migración, DDL, Fase 4, Fase 7, despliegue ni mutación de QA. La autoridad activa sigue siendo v1.4 hasta aprobación humana y materialización gobernada de v1.5.
...
El gate exige aprobación del candidato rector, modelo físico enmendado, contratos ejecutables enmendados, plan incremental, tenant-isolation review, rebuild/upgrade/rollback/restore contracts y evidencia de no duplicación de autoridad.
