# 33 - Catálogo completo de entidades canónicas por bounded context — v1.6 candidate

> Candidate baseline: `TCDX_GRC_MASTER_REGENT_BASELINE_v1.6_2026-09-23`.
> Status: `PENDING_HUMAN_APPROVAL`; active v1.5 remains unchanged.
